"""
Information Depth Inference Module
...
# Define paths
DEPLOY_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "information_depth")
...
def predict(features, model_type="standard"):
    """
    Make a prediction with the information depth model.
    ...
    --------
    numpy.ndarray
        Predicted information depth scores.
    """
